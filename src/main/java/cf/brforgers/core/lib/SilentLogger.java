...
/**
 * Yes, it's a Silent Logger. Why? You can set a Log4j's Logger to this and you'll Silent the Code.
 * <br> Also useful to fix {@link NullPointerException}s caused by Loggers that have been not yet initialized
 * @author TheFreeHigh
 *
 */
public class SilentLogger implements Logger {
	...
	@Override
	public <R> R exit(R result) {return null;}
	...
	@Override
	public boolean isEnabled(Level level, Marker marker) {return false;}
	...
	@Override
	public boolean isFatalEnabled(Marker marker) {return false;}
	...
	@Override
	public <T extends Throwable> T throwing(Level level, T t) {return null;}

	@Override
	public <T extends Throwable> T throwing(T t) {return null;}
